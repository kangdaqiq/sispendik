...
Route::post('/pendaftaran/check-nik-nisn', [PendaftaranController::class , 'checkNikNisn'])->name('pendaftaran.checkNikNisn');
Route::post('/pendaftaran/upload-temp', [PendaftaranController::class , 'uploadTemp'])->name('pendaftaran.uploadTemp');
