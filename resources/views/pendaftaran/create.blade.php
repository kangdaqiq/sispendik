<x-registration-layout>
    ...
    <form method="POST" action="{{ route('pendaftaran.store') }}" enctype="multipart/form-data" class="space-y-8" x-data="{ step: 1 }">
        @csrf
        ...
        <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div>
                    ...
                    <x-text-input id="dari_bersaudara" class="block mt-1 w-full" type="number" name="dari_bersaudara"
                        :value="old('dari_bersaudara')" required />
                </div>
                <div>
        ...
        <div x-show="step === 2" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-between">
                <button type="button" @click="step = 1; window.scrollTo({top: 0, behavior: 'smooth'})" class="bg-white border border-gray-300 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg shadow-sm transition-colors text-gray-700 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-show="step === 3" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="grid grid-cols-1 gap-8">
                ...
                <div class="bg-gray-50/80 p-5 rounded-xl border border-gray-200">
                    ...
                    <div class="ayah_detail">
                        ...
                        <x-text-input id="no_telp_ayah" class="block mt-1 w-full" type="text" name="no_telp_ayah"
                    ...
                    <div class="ayah_detail">
                        ...
                        <x-text-input id="pekerjaan_ayah" class="block mt-1 w-full" type="text" name="pekerjaan_ayah"
            ...
            <div id="data_wali_container" class="bg-blue-50 p-4 rounded-md border" style="display: none;">
                <h4 class="font-medium text-blue-800 mb-2">Data Wali (Wajib diisi jika kedua orang tua telah meninggal)
                </h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <x-text-input id="no_telp_wali" class="block mt-1 w-full" type="text" name="no_telp_wali"
                    ...
                    <div>
                        ...
                        <select id="pendidikan_wali" name="pendidikan_wali"
                            ...
                            <option value="D1-D3" {{ old('pendidikan_wali') == 'D1-D3' ? 'selected' : '' }}>D1 - D3</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="pekerjaan_wali" class="block mt-1 w-full" type="text" name="pekerjaan_wali"
            ...
            <div class="mt-8 pt-8 border-t border-gray-100">
                ...
                <div id="alamat_ortu_container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" style="position: relative;">
                    ...
                    <div id="alamat_ortu_overlay" style="display: none; position: absolute; top:-10px; left:-10px; right:-10px; bottom:-10px; background: rgba(249, 250, 251, 0.5); z-index: 5; pointer-events: none; border-radius: 0.5rem;"></div>
                    <div>
                    ...
                    <div>
                        ...
                        <x-text-input id="kode_pos_ortu" class="block mt-1 w-full bg-gray-50" type="text" name="kode_pos_ortu"
                            :value="old('kode_pos_ortu')" maxlength="10" />
                        <p class="text-xs text-gray-500 mt-1">Terisi otomatis berdasarkan Desa/Kecamatan</p>
                    </div>
            ...
            <!-- Step 3 Navigation -->
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-between">
                <button type="button" @click="step = 2; window.scrollTo({top: 0, behavior: 'smooth'})" class="bg-white border border-gray-300 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg shadow-sm transition-colors text-gray-700 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                    Sebelumnya
        ...
        <div x-show="step === 4" x-cloak style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div id="ktp_ortu_container" class="bg-gray-50 border border-gray-200 border-dashed rounded-xl p-6 text-center hover:bg-indigo-50 hover:border-indigo-300 transition-colors">
                    ...
                    <x-input-label for="foto_ktp_ortu" value="KTP Orang Tua (Wajib jika hidup)" class="font-bold text-gray-700" />
                    @if(old('temp_foto_ktp_ortu'))
                        <input type="hidden" name="temp_foto_ktp_ortu" value="{{ old('temp_foto_ktp_ortu') }}">
                        <input type="hidden" name="temp_foto_ktp_ortu_name" value="{{ old('temp_foto_ktp_ortu_name') }}">
                ...
                <div class="bg-gray-50 border border-gray-200 border-dashed rounded-xl p-6 text-center hover:bg-indigo-50 hover:border-indigo-300 transition-colors">
                    ...
                    <x-input-label for="foto_akte_kelahiran" value="Akte Kelahiran (Wajib)" class="font-bold text-gray-700" />
                    @if(old('temp_foto_akte_kelahiran'))
                        <input type="hidden" name="temp_foto_akte_kelahiran" value="{{ old('temp_foto_akte_kelahiran') }}">
                        <input type="hidden" name="temp_foto_akte_kelahiran_name" value="{{ old('temp_foto_akte_kelahiran_name') }}">
                ...
                <div class="bg-gray-50 border border-gray-200 border-dashed rounded-xl p-6 text-center hover:bg-indigo-50 hover:border-indigo-300 transition-colors">
                    ...
                    <x-input-label for="ijazah_terakhir" value="Ijazah Terakhir / SKL (Wajib)" class="font-bold text-gray-700" />
                    @if(old('temp_ijazah_terakhir'))
                        <input type="hidden" name="temp_ijazah_terakhir" value="{{ old('temp_ijazah_terakhir') }}">
                        <input type="hidden" name="temp_ijazah_terakhir_name" value="{{ old('temp_ijazah_terakhir_name') }}">
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-between items-center">
                <button type="button" @click="step = 3; window.scrollTo({top: 0, behavior: 'smooth'})" class="bg-white border border-gray-300 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg shadow-sm transition-colors text-gray-700 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                    Sebelumnya
